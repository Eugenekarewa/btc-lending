...
import { DollarSign, Calculator, AlertTriangle, CheckCircle, Clock } from 'lucide-react';
...
interface LoanRequestProps {
  lockData: LockData;
  onLoanRequest: (loanRequest: any) => Promise<void>;
  btcPrice: number;
}
...
const LoanRequest: React.FC<LoanRequestProps> = ({ lockData, onLoanRequest, btcPrice }) => {
        ...
        {loanAmountNum > 0 && (
          <div className="p-4 bg-gray-50 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <span className="text-gray-600">Health Factor:</span>
                <span className={`ml-2 font-semibold ${risk.bgColor}`}>{healthFactor.toFixed(2)}</span>
              </div>
            </div>
